...
preview: https://dlizcano.github.io/activity/fig/danta.png
twitter:
  site: "@rstudio"
  creator: "@dlizcano"
---
...
tapir <- camaras %>% 
 ...
 for (i in 1:length(tapir)){
  if(dim(tapir[[i]])[1] <= 10) # skip if menos 10 records
    next
 cat("###", names(tapir)[i])
  # plot.new( )
...
# Foto
 ...
 [![tapir](https://dlizcano.github.io/activity/fig/danta_small.jpg)]( https://dlizcano.github.io/activity/fig/danta_large.jpg)

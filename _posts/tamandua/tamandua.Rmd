...
tamandua_selva <- filter(camaras, Species=="Tamandua tetradactyla" & subproject_name=="Selva Vides")
by_sp <- camaras %>%  group_by(Species) %>% tally()
by_sp_predio <- tamandua_selva %>%  group_by(deployment_id) %>% tally()
names(by_sp_predio) <-  c("Camara", "Fotos tamandua", "geometry")
...
# Foto
 ...
 ![Mazama](https://dlizcano.github.io/activity/fig/tamandua_small.jpg)

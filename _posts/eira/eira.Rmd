...
mapview(camaras_unique, cex=1, col.regions = "black") + mapview(fotografias,  cex = "Fotos tayra", alpha = 0, map.types=c("Esri.WorldImagery", "OpenTopoMap"))
...
eira <- camaras %>% 
  ...
  dplyr::filter (Species =="Eira barbara" )  %>% as.data.frame()
